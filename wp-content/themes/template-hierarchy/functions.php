...
// Create widgets 
create_widget("Primary Sidebar-Widget-functions.php", "primary", "Displays on the side of most pages");
create_widget("Blog Sidebar-Widget-functions.php", "blog", "Displays on the side of the blog section");
